        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-lg-6 col-md-6">
                    <img src="hospitalabout.png" class="img-fluid" width="100%" alt="Hospital Image">
                </div>
                <div class="col-sm-12 col-lg-6 col-md-6 text-center align-items-center justify-content center">
                    <h2>About us</h2>
