...
if (isset($_GET['id'])) {
    ...
    $sql = "UPDATE hospital_info SET enq_status = 1 WHERE id = $id";

    if ($conn->query($sql) === TRUE) {
        // Redirect to another page after a successful update
        echo "<script type='text/javascript'>alert('Request Approved');window.location.href='accept_enquery.php';</script>";
    } else {
