...
<body>
  <div class="sidebar">
    ...
    <ul class="nav-links">
        ...
        <li>
          <a href="addhospital.php" class="active">
  ...
  <section class="home-section">
    ...
    <div class="container hospital" style="margin-top:100px;">
        <div class="forms">
            <div class="form login">
                <span class="title">Hospital Signup</span>

                <form action="addhospitalbk.php" method="POST">
