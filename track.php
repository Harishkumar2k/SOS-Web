...
<body>
    ...
    <script>
        function createCustomMarker(location, color, title, map) {
            var userIcon = {
                url: 'map/sos.png', // Path to your custom marker image
        ...
        function initMap(latitude, longitude) {
            ...
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(function(position) {
                    ...
                    addUserMarker(userLocation, 'Your Logo', 'map/walk.png', map);
                });
            }
        ...
        function watchUserLocation() {
            if (navigator.geolocation) {
                navigator.geolocation.watchPosition(function(position) {
                    ...
                    addUserMarker(userLocation, 'Your Location', 'map/walk.png', map);
                });
            } else {
